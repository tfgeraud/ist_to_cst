...
//boolean ist_is_condition_nat_rct(ISTInterval *val1, ISTInterval *val2, boolean is_Nat); //simulation NAT
boolean ist_is_condition_nat_rct(ISTInterval *val1, ISTInterval *val2, ISTInterval *val3, boolean is_Nat); //simulation RCT
